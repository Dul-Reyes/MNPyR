...
A este tipo de pruebas se les conoce como funciones de distribución empíricas cuadráticas **(QEDF)** por sus siglas en inglés.
De esta manera la estadística de la prueba **Anderson-Darling** se obtiene de integrar la siguiente función **QEDF**:
...
Dado que el estadístico no depende de $F(X)$ y sólo depende de $n$ entonces la distribución asintótica de **Anderson-Darling** es la que se muestra a continuación, asimismo se mostrarán algunos ajustes a la estadística con la finalidad de que la prueba sea más potente para determinados
casos:
