...
La manera de estudiar esto es identificando a los individuos encuestados con parejas ordenadas de la forma (0,0),(0,1),(1,0) o (1,1) donde la primera entrada representa la **postura** del individuo antes del debate y la segunda representa su postura después, (por ejemplo, "0" puede representar **en contra** y "1" **a favor**).
