...
Como nos interesa la probabilidad del resultado "clase 1", dejaremos que el estadístico de prueba $T$ sea el número de veces que el resultado es **"clase 1"**.
...
*Para algunos será el primer contacto con R y el formato de R-Markdown asi que pueden consultar en @Grolemud2014Introduction y @Publico2000introduccion.
