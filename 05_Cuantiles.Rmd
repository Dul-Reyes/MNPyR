...
Donde $Z_{q}$ es el cuantil de una distribución normal estándar que se puede obtener en la tabla correspondiente[^5.1]. 
...
[^5.1]: Véase que de acuerdo al tipo de cuantil (de cola inferior o superior), el signo del cuantil $Z_p$ cambiará.