...
Ahora calcularemos los residuales, es decir la diferencia entre los valores observados y los valores estimados. $e_i = y_i −\hat{y_i}$ 
...
Y luego los residuales y los graﬁcamos
...
Para que el modelo propuesto ajuste bien a los datos originales esperariamos que los residuales estuvieran lo mas cercano al cero (linea amarilla). Mas adelante veremos como usar estos gráﬁco para veriﬁcar algunos de los supuestos del modelo.
