...
\begin{center}\includegraphics{_main_files/figure-latex/unnamed-chunk-105-2} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/unnamed-chunk-136-1} \end{center}
