...
\hypersetup{
  ...
  pdfauthor={Sofía Villers Gómez; Dulce María Reyes Varela},
  hidelinks,
...
\begin{center}\includegraphics{_main_files/figure-latex/unnamed-chunk-102-2} \end{center}
...
\NormalTok{s3d }\OtherTok{\textless{}{-}} \FunctionTok{scatterplot3d}\NormalTok{(trees, }\AttributeTok{type =} \StringTok{"h"}\NormalTok{, }\AttributeTok{color =} \StringTok{"blue"}\NormalTok{,}
    \AttributeTok{angle=}\DecValTok{55}\NormalTok{, }\AttributeTok{pch =} \DecValTok{16}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"Diametro del arbol"}\NormalTok{,}\AttributeTok{ylab =} \StringTok{"Altura del arbol"}\NormalTok{, }\AttributeTok{zlab=}\StringTok{"Volumen"}\NormalTok{)}
\NormalTok{my.lm }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(trees}\SpecialCharTok{$}\NormalTok{Volume }\SpecialCharTok{\textasciitilde{}}\NormalTok{ trees}\SpecialCharTok{$}\NormalTok{Girth }\SpecialCharTok{+}\NormalTok{ trees}\SpecialCharTok{$}\NormalTok{Height)}
\NormalTok{s3d}\SpecialCharTok{$}\FunctionTok{plane3d}\NormalTok{(my.lm)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{_main_files/figure-latex/unnamed-chunk-129-1} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/unnamed-chunk-143-1} \end{center}
